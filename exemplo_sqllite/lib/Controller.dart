import 'package:exemplo_sqllite/Model.dart'; // Importa o modelo de dados ContatoModel
import 'package:path/path.dart'; // Importa a função join para manipulação de caminhos de arquivo
import 'package:sqflite/sqflite.dart'; // Importa o pacote sqflite para operações com SQLite
...
class BancoDadosCrud {
  ...
  Future<void> create(ContatoModel model) async {
    try {
      ...
      print(ex); // Imprime qualquer exceção que ocorra durante a inserção
      return;
    }
  }
  ...
  Future<List<ContatoModel>> getContacts() async {
    try {
      ...
      print(ex); // Imprime qualquer exceção que ocorra durante a consulta
      return [];
    }
  }
  ...
  Future<void> update(ContatoModel model) async {
    try {
      ...
      print(ex); // Imprime qualquer exceção que ocorra durante a atualização
      return;
    }
  }
  ...
  Future<void> delete(int id) async {
    try {
      ...
      print(ex); // Imprime qualquer exceção que ocorra durante a exclusão
      return;
    }
  }
}
